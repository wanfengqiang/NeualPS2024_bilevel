...
class RGBEncoder(nn.Module):
    def __init__(self):
        ...
        pretrained_dict = torch.load('../new/pytorch-i3d-master/models/rgb_imagenet.pt')
...
class OFEncoder(nn.Module):
    def __init__(self):
        ...
        #download the checkpoint from https://github.com/piergiaj/pytorch-i3d/tree/master/models
        # https://github.com/piergiaj/pytorch-i3d/tree/master
        pretrained_dict = torch.load('../new/pytorch-i3d-master/models/flow_imagenet.pt')
        model_dict = model.state_dict()
        pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict}
        model_dict.update(pretrained_dict)
        model.load_state_dict(model_dict)
...
class DepthEncoder(nn.Module):
    def __init__(self):
        ...
        #download the checkpoint from https://github.com/piergiaj/pytorch-i3d/tree/master/models
        # https://github.com/piergiaj/pytorch-i3d/tree/master
        pretrained_dict = torch.load('/data/wfq/new/pytorch-i3d-master/models/rgb_imagenet.pt')
        model_dict = model.state_dict()
        pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict}
        model_dict.update(pretrained_dict)
        model.load_state_dict(model_dict)
